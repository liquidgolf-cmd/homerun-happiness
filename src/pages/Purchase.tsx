    ...
    <div className="min-h-screen bg-gradient-to-br from-loam-neutral to-loam-neutral px-4 py-12">
      <div className="max-w-lg mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Turn your snapshot into your full journey</h1>
          <p className="text-gray-600 mb-6">
            You&apos;ve seen your snapshot. Run the full path—AI coaching through every base, built around your answers.
          </p>
          ...
          <p className="text-sm text-gray-700 mb-4">
            Full access: At Bat → First Base → Second Base → Third Base → Home Plate + your journey report.
          </p>
          <p className="text-sm text-gray-600 mb-6">{CONVERSION_COPY.TRUST_LINE}</p>
          <a
          ...
          <p className="mt-6 text-sm text-gray-500">
            After payment you&apos;ll sign in and land on your first base.
          </p>
